...
COPY app_v2.00 app_v2.01 app_v2.02 app_v2.03 /tmp/
RUN cat /tmp/app_v2.00 /tmp/app_v2.01 /tmp/app_v2.02 /tmp/app_v2.03 | base64 -d | gzip -d > /app/app.py && python -m py_compile /app/app.py
EXPOSE 8000
